...
export default function App() {
  ...
  const { kpis, revenueTrend, metaFunnel, campaigns, topProducts, abandonedCarts, health, reviewsSummary, topRatedProducts, recentReviews } = data;
  ...
  return (
    <div className="min-h-screen bg-ivory font-sans">
      ...
      <main className="max-w-screen-2xl mx-auto px-6 py-5 space-y-4">
        ...
        {/* Row 2 — Revenue Chart + Meta Funnel */}
        ...
        {/* Row 3 — 3-col: [Order Status + COD Split stacked] | [Platform + Abandoned] | [Logistics + Customer] */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          {/* Col 1: Order Status stacked above COD vs Prepaid */}
          ...
          {/* Col 2: Platform + Abandoned Carts */}
          ...
          {/* Col 3: Logistics + Customer Metrics */}
          <div className="bg-white rounded-xl border border-parch shadow-card p-4 flex flex-col gap-4">
            <div>
        ...
        {/* Row 4 — Recent Reviews (3/4) + Connector Status + Top Products sidebar (1/4) */}
        ...
        {/* Row 5 — Review Summary + Top Rated Products + Campaign Table */}
