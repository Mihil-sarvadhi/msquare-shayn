...
router.get('/inventory/summary', controller.inventorySummaryHandler);
router.get('/inventory/fast-moving', controller.fastMovingSkusHandler);
router.get('/inventory/zero-orders', controller.zeroOrderSkusHandler);
