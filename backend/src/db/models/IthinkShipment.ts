...
interface Attrs {
  ...
  billed_fwd_charges?: number;
  billed_rto_charges?: number;
  billed_cod_charges?: number;
  billed_gst_charges?: number;
  billed_total?: number;
...
export class IthinkShipment extends Model<Attrs, CA> implements Attrs {
  ...
  declare current_status_code?: string;
  declare customer_state?: string;
  declare customer_city?: string;
  declare customer_pincode?: string;
  declare billed_fwd_charges?: number;
  declare billed_rto_charges?: number;
  declare billed_cod_charges?: number;
  declare billed_gst_charges?: number;
  declare billed_total?: number;
  declare remittance_amount?: number;
  declare ofd_count?: number;
  declare delivered_date?: string;
  declare rto_date?: string;
  declare expected_delivery?: string;
...
IthinkShipment.init(
  {
    ...
    current_status_code: DataTypes.TEXT,
    customer_state: DataTypes.TEXT,
    customer_city: DataTypes.TEXT,
    customer_pincode: DataTypes.TEXT,
    billed_fwd_charges: DataTypes.DECIMAL(10, 2),
    billed_rto_charges: DataTypes.DECIMAL(10, 2),
    billed_cod_charges: DataTypes.DECIMAL(10, 2),
    billed_gst_charges: DataTypes.DECIMAL(10, 2),
    billed_total: DataTypes.DECIMAL(10, 2),
    remittance_amount: DataTypes.DECIMAL(10, 2),
    ofd_count: { type: DataTypes.INTEGER, defaultValue: 0 },
    delivered_date: DataTypes.DATEONLY,
    rto_date: DataTypes.DATEONLY,
